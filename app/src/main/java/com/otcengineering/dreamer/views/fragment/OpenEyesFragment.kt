...
import com.otcengineering.dreamer.databinding.FragmentOpeneyesBinding


class OpenEyesFragment : Fragment() {
    private val binding: FragmentOpeneyesBinding by lazy { FragmentOpeneyesBinding.inflate(layoutInflater) }
